package com.hypinx.coding.capitalone.powerday.simplebanking.solutionV3;
...
/**
 * The SimplifiedBankingInMemory class will contain the logic for the banking system
 */
class SimplifiedBankingInMemory {
    /**
